...
export const SECCIONES_MAS: Array<{
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/tablero/accesos', texto: 'Accesos', icono: 'ShieldCheck', permiso: 'configuracion.configurar', descripcion: 'Qué módulo ve cada persona' },
...
const TITULOS: Array<[string, string]> = [
  ...
  ['/obras', 'Obras'],
  ['/alertas', 'Alertas'],
  ['/tablero/accesos', 'Accesos'],
  ['/tablero/imprimir', 'Resumen'],
  ['/tablero/obra', 'Obra'],
  ['/tablero', 'Tablero'],
